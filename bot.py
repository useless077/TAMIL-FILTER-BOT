...
async def start():
    ...
    bot_info = await TamiliniBot.get_me()
    ...
    for name in files:
        with open(name) as a:
            ...
            print("TamilBot Imported => " + plugin_name)
    if ON_HEROKU:
    ...
    await TamiliniBot.send_message(chat_id=LOG_CHANNEL, text=script.RESTART_TXT.format(today, time))
    if CLONE_MODE == True:
